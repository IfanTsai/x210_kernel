...
/* ioctls
   0x46 is 'F'								*/
#define FBIOGET_VSCREENINFO	0x4600    // 获取LCD可变信息
#define FBIOPUT_VSCREENINFO	0x4601    // 设置LCD可变信息
#define FBIOGET_FSCREENINFO	0x4602    // 获取LCD不可变信息
...
struct fb_info {
	int node;             // fb_info在registered_fb数组中的下标，作为次设备号
	int flags;
